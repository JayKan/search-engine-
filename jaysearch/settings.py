# Django settings for jaysearch project.
...
DATABASES = {
    'default': {
        ...
        'NAME':  'jaysearch',                      # Or path to database file if using sqlite3.
        'USER': 'jaysearch_user',                      # Not used with sqlite3.
        'PASSWORD': '6DQuO!pUHH0uooZgy6tuxGQIKtCkAn',                  # Not used with sqlite3.
...
SECRET_KEY = 'm*xloZp[M9PBZO`/rX:OJO#^kS1QG|A4X+iHw{_Yy;%*b,yk"7'
...
ROOT_URLCONF = 'jaysearch.urls'

WSGI_APPLICATION = 'jaysearch.wsgi.application'
